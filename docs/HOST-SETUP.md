...
procedure configuration and its equipment allowlist, but no LLM/embedding settings.
...
The explicit migration command applies operational migrations 001–004, knowledge
